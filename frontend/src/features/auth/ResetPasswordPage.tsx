    ...
    try {
      ...
      setServerError(
        err instanceof ApiError
          ? err.message
          : 'Não foi possível solicitar a nova senha. Tente novamente.',
      );
    }
  }
    ...
    <div className="login-screen">
      <Card className="login-card">
        ...
        <p className="login-sub">
          Informe o CPF/CNPJ e o e-mail cadastrados no gateway — se coincidirem,
          uma nova senha é enviada por e-mail.
        </p>
